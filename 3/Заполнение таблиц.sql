...
FROM (VALUES
    ...
    (2000.00, 'Хороший сервис.', 1, 1, 'Россия', 'Новосибирск', 'Красноярская улица', '15'),
    (2500.00, 'Быстрая доставка.', 1, 2, 'Россия', 'Екатеринбург', 'Свердловская улица', '25'),
    (3000.00, 'Все понравилось.', 1, 1, 'Россия', 'Казань', 'Бауманская улица', '37'),
    (3500.00, 'Качество товаров отличное.', 1, 2, 'Россия', 'Нижний Новгород', 'Горьковская улица', '47'),
    (4000.00, 'Спасибо за оперативность.', 1, 1, 'Россия', 'Челябинск', 'Кировская улица', '57'),
    (4500.00, 'Отличные цены.', 1, 2, 'Россия', 'Самара', 'Советская улица', '67'),
    (5000.00, 'Рекомендую всем.', 1, 1, 'Россия', 'Омск', 'Маршала Жукова улица', '77'),
    (5500.00, 'Очень доволен покупкой.', 1, 2, 'Россия', 'Ростов-на-Дону', 'Пушкинская улица', '87')
